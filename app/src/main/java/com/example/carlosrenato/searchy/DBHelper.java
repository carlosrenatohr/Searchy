...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "BDJP.sqlite";
...
//        db.execSQL("CREATE TABLE " + CLIENTES_TABLE + " (ITEM integer primary key autoincrement, NOMBRE text, DIRECCION text, NUMERO text)");
    }
